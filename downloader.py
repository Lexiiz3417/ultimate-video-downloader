...
class App(customtkinter.CTk):
    ...
    def show_about_window(self):
        ...
        github_link_label=customtkinter.CTkLabel(self.about_win,text="Lihat di GitHub",text_color="#6495ED",font=customtkinter.CTkFont(size=12,underline=True),cursor="hand2"); github_link_label.pack(pady=(10, 5)); github_link_label.bind("<Button-1>", lambda e: webbrowser.open_new_tab("https://github.com/Lexiiz3417/ultimate-video-downloader.git"))
